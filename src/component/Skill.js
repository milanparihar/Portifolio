    ...
    <div className="skill" id="skill12">
      <div className="contact__header">
        <div className="container" >
          ...
          <div className="row">
            <div className="col-6">
              <p className="heading">I`M EXPERT ON</p>
              <h1>Let`s Work Together</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque
                ipsa at non eveniet sit possimus facere ut repellendus
                inventore. Quas culpa suscipit nemo ratione ea vitae quod
                voluptatum magni totam!{" "}
              </p>
              <Link
                to="contact"
                id="contact12" 
